...
import osp.leobert.android.router.compiler.model.GroupInfo;
import osp.leobert.android.router.compiler.utils.AnnoUtils;
...
import osp.leobert.android.router.facade.model.Node;
import osp.leobert.android.router.facade.model.NodeParamsConfig;

import static javax.lang.model.element.Modifier.FINAL;
import static javax.lang.model.element.Modifier.PUBLIC;
import static osp.leobert.android.router.compiler.Constants.ACTIVITY;
import static osp.leobert.android.router.compiler.Constants.ANNOTATION_TYPE_ROUTER;
import static osp.leobert.android.router.compiler.Constants.ANNOTATION_TYPE_ROUTE_NODE;
import static osp.leobert.android.router.compiler.Constants.ANNOTATION_TYPE_UIROUTERSHOLDER;
 ...
 * <p><b>Description:</b> Annotation Processor for：RouteNode、Route、UiRouterHolder。
 * need to config the path of the param parser via option, with key:"path_util_paramparser"</p>
